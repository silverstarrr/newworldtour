...
public interface ReservationMapper {
	...
	ForeignHomeGoodsInfoVO maxForeignGoodsInfos(ReservationInfoVO foreignGoodsInfoVO);	//패키지 구매 정원 제한
	ForeignHomeGoodsInfoVO maxHomeGoodsInfos(ReservationInfoVO foreignGoodsInfoVO);	//패키지 구매 정원 제한
	...
	ForeignHomeGoodsInfoVO maxgoods (ForeignHomeGoodsInfoVO foreignGoodsInfoVO);
	...
	//동행인
	int insertCompanion(@Param("companionList")List<CompanionInfoVO> companionInfoVO);	//동행인 DB 저장
