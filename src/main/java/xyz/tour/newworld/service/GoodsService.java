...
public class GoodsService {
	...
	public ForeignHomeGoodsInfoVO getGoods(ForeignHomeGoodsInfoVO foreignHomeGoodsInfo) {	//패키지 상세 페이지에서 패키지 정보 불러오기
		return goodsInfoMapper.getGoods(foreignHomeGoodsInfo);
	}
