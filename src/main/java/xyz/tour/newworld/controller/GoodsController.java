...
public class GoodsController {
	...
	//공통
	@GetMapping("/getGoods/{giCode}/{giEtc}")	//패키지 상세 페이지에서 패키지 정보 불러오기
	@ResponseBody
	public ForeignHomeGoodsInfoVO getGoods(ForeignHomeGoodsInfoVO foreignHomeGoodsInfo, @PathVariable("giCode") String giCode, @PathVariable("giEtc") String giEtc) {
		return goodsService.getGoods(foreignHomeGoodsInfo);
	}
