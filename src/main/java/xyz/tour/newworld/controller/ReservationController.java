...
public class ReservationController {
	...
	//공통
	@GetMapping("/reservation/{giCode}/{giEtc}")	//예약 페이지에 항공, 상품 테이블에서 정보 불러오기
	@ResponseBody
	public ForeignHomeGoodsInfoVO getGoodsFlight(ForeignHomeGoodsInfoVO foreignGoodsInfoVO, @PathVariable("giCode") String giCode, @PathVariable("giEtc") String giEtc) {
	...
	@ResponseBody
	public ReservationInfoVO insertReservation(@RequestBody ReservationInfoVO reservationInfoVO) {
	...
	//동행인
	@PostMapping("/reservation/companion/{riCode}")	//동행인 DB 저장
	@ResponseBody
	public int insertCompanion(@RequestBody List<CompanionInfoVO> companionInfoVO, @PathVariable("riCode") String riCode) {
		//companionInfoVO.SET
	...
	@ResponseBody
	public ReservationInfoVO insertHomeReservation(@RequestBody ReservationInfoVO reservationInfoVO) {
