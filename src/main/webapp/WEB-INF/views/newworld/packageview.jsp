...
<script src="https://kit.fontawesome.com/4efa714ed8.js"
			...
			<div class="page1">
				<div class="smallnav">
					<ul>
						...
						<li><a
							href="/views/newworld/packageview?giCode=${param.giCode}">패키지
								상세조회</a></li>
					</ul>
				</div>
				...
				<div class="resurpage">
					...
					<div class="packinfo">
						...
						<div id="carouselExampleIndicators" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active" id="imageslide1"></div>
								<div class="carousel-item" id="imageslide2"></div>
								<div class="carousel-item" id="imageslide3"></div>
							</div>
						...
						<div id="heart_review" class="collectbtn">
							<div id="heart">
								<i class="fa-regular fa-heart fa-lg"
									...
									onclick="toggleHeart('${param.giCode}',this)"> <span
									style="color: black; font-size: 15px; cursor: pointer;">찜하기</span>
								</i>
							</div>
							<span class="material-symbols-outlined">rate_review</span>
							<spna class="reviewCount"></spna>
						</div>
					...
					<div class="rightmenu">
						<div class="resurchoice">
							<div class="resurtext">
								...
								<br>
								<p>
									성인<br> <span style="font-weight: bold;" id="giPriceAdult"></span>원
								</p>
								<br>
								<p>
									아동<br> <span style="font-weight: bold;" id="giPriceKid"></span>원
								</p>
								<br>
								<p>
									유아<br> <span style="font-weight: bold;" id="giPriceBaby"></span>원
								</p>
								<div class="peoplenumber">
									<div class="btngroup">
										<button onclick="count('minus1')">
											<img src="/resources/images/icon/minus.png" width="24px">
										</button>
										<input type=text id="riAdultCount" class="num_sum"
											maxlength='2' style="text-indent: 3px">
										<button onclick="count('plus1')">
											<img src="/resources/images/icon/plus.png" width="24px">
										</button>
										<br>
									</div>

									<div class="btngroup">
										<button onclick="count('minus2')">
											<img src="/resources/images/icon/minus.png" width="24px">
										</button>
										<input type=text id="riKidsCount" class="num_sum"
											maxlength='2' style="text-indent: 3px">
										<button onclick="count('plus2')">
											<img src="/resources/images/icon/plus.png" width="24px">
										</button>
										<br>
									</div>
									...
									<div class="btngroup">
										<button onclick="count('minus3')">
											<img src="/resources/images/icon/minus.png" width="24px">
										</button>
										<input type=text id="riBabyCount" class="num_sum"
											maxlength='2' style="text-indent: 3px">
										<button onclick="count('plus3')">
											<img src="/resources/images/icon/plus.png" width="24px">
										</button>
										<br>
									</div>
								...
								<div class="summoney">
									...
									<br>
									<p style="text-align: right; font-size: 30px; color: #3162C7">
										<span style="font-weight: bold;" id="riTgiPrice"></span>원
									</p>
									<center>
										<button class="resurbtn" style="width: 250px; height: 50px;"
											onclick="foreignReserv()">예약하기</button>
									</center>
								</div>
							</div>
						</div>
					...
					<div class="tourinfo">
						...
						<dl>
							...
							<dd>
								<p>
									<span id="giPeriod"></span> &nbsp;&nbsp;&nbsp;&nbsp;<span
										id="viName"></span><br> 출발: &nbsp;<span id="viStart"></span>
									&nbsp;/&nbsp;도착: &nbsp;<span id="viArr"></span>
								</p>
							</dd>
							<dt>여행도시</dt>
							<dd>
								<p>
									<span id="viDeparture"></span> - <span id="viDestination"></span>
								</p>
							</dd>
							<dt>예약현황</dt>
							<dd>
								<p>
									정원: <span id="giMax"></span> 잔여: <span class="restSeat"></span>
								</p>
							</dd>
						</dl>
					</div>
					...
					<div class="bumtable">
						...
						<table class="table table-border w-100">
							<thead class="table-primary">
								<tr
									style="font-weight: bold; text-align: center; line-height: 60px;">
									<td>구분</td>
									<td>성인</td>
									<td>아동</td>
									<td>유아</td>
...
function foreignReserv() {
	location.href='/views/newworld/reservationapply?giEtc=${param.giEtc}&giCode=${param.giCode}&riAdultCount=' + document.querySelector('#riAdultCount').value +
...
function getGoodsInfos() {
	fetch('/getGoods/${param.giCode}/${param.giEtc}')
	.then(function(res) {
		return res.json();
	})
	.then(function(data) {
