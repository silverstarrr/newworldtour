...
function displayData(currentPage, dataPerPage) {
	...
	i++
		...
		/* for(let i = 0; i < dataList.length; i++) { */
			...
			console.log(num);
			html += '<tr>';
			html += '<th scope="row" rowspan="6" style="cursor: pointer;">' + '<img src="' + goodsInfos.giImage1 + '"width="300px" onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '&giEtc=' + goodsInfos.giEtc + '\'">' + '</th>';
			html += '<tr onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '&giEtc=' + goodsInfos.giEtc + '\'">' + '<td style="font-size:26px; font-weight:bold; cursor: pointer;">' + goodsInfos.giName + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + goodsInfos.giHashtag + '</td>' + '</tr>';
			html += '<tr>' + '<td>' + '기간: ' + goodsInfos.giPeriodAbout + '</td></tr>';
			html += '<tr>' + '<td>' + goodsInfos.giPeriod + '</td></tr>';
			html += '<tr style="text-align: right;">' + '<td style="cursor: pointer;" onclick="location.href=\'/views/newworld/packageview?giCode=' + goodsInfos.giCode + '&giEtc=' + goodsInfos.giEtc + '\'">' + '<a style="font-size:26px; font-weight:bold; color:#4374D9">' + num + '원' + '</a>' + '</td>';
