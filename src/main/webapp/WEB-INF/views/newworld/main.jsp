...
<div id="main_page_3">
	...
	<p class="utitle">떠나자, 모든 여행 신나라만 믿고 🗽</p>
...
function mainGoods() {
	...
	.then(function(data) {
		...
		let goods1 = '';
		goods1 += '<a href="/views/newworld/packageview?giCode=HW01&giEtc=foreign">';
		goods1 += '<img src="' + data[0].giImage1 + '" alt="" width="280px"></a><br>';
		goods1 += '<a class="text1" href="/views/newworld/packageview?giCode=HW01&giEtc=foreign">' + '알로하 모히또! 하와이!' + '</a><br>';
		goods1 += '<small><a href="/views/newworld/packageview?giCode=HW01&giEtc=foreign">' + data[0].giHashtag + '</a></small><br>';
		goods1 += '<b><a href="/views/newworld/packageview?giCode=HW01&giEtc=foreign">' + price1 + '</b>원</a>';
		document.querySelector('div.goods1').innerHTML = goods1;
		
		let goods2 = '';
		goods2 += '<a href="/views/newworld/packageview?giCode=FR01&giEtc=foreign">';
		goods2 += '<img src="' + data[1].giImage1 + '" alt="" width="280px"></a><br>';
		goods2 += '<a class="text1" href="/views/newworld/packageview?giCode=FR01&giEtc=foreign">' + '오감이 행복한 프랑스' + '</a><br>';
		goods2 += '<small><a href="/views/newworld/packageview?giCode=FR01&giEtc=foreign">' + data[1].giHashtag + '</a></small><br>';
		goods2 += '<b><a href="/views/newworld/packageview?giCode=FR01&giEtc=foreign">' + price2 + '</b>원</a>';
		document.querySelector('div.goods2').innerHTML = goods2;
		
		let goods3 = '';
		goods3 += '<a href="/views/newworld/packageview?giCode=BU01&giEtc=home">';
		goods3 += '<img src="' + data[2].giImage1 + '" alt="" width="280px"></a><br>';
		goods3 += '<a class="text1" href="/views/newworld/packageview?giCode=BU01&giEtc=home">' + '파란 수도 부산으로 떠나요!' + '</a><br>';
		goods3 += '<small><a href="/views/newworld/packageview?giCode=BU01&giEtc=home">' + data[2].giHashtag + '</a></small><br>';
		goods3 += '<b><a href="/views/newworld/packageview?giCode=BU01&giEtc=home">' + price3 + '</b>원</a>';
		document.querySelector('div.goods3').innerHTML = goods3;
		
		let goods4 = '';
		goods4 += '<a href="/views/newworld/packageview?giCode=JE01&giEtc=home">';
		goods4 += '<img src="' + data[3].giImage1 + '" alt="" width="280px"></a><br>';
		goods4 += '<a class="text1" href="/views/newworld/packageview?giCode=JE01&giEtc=home">' + '혼자옵서예 제주' + '</a><br>';
		goods4 += '<small><a href="/views/newworld/packageview?giCode=JE01&giEtc=home">' + data[3].giHashtag + '</a></small><br>';
		goods4 += '<b><a href="/views/newworld/packageview?giCode=JE01&giEtc=home">' + price4 + '</b>원</a>';
